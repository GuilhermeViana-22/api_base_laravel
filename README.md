...
## Produção (um container, porta 8019)
...
migrations, sobe a fila em segundo plano e serve a API na porta **8019**.
...
| Variável | Uso |
|---|---|
| `APP_KEY`, `APP_URL`, `DB_*` | padrão do Laravel (`APP_URL` monta a URL das imagens) |
